...
from arithmetic.db.dao.dummy_dao import DummyDAO
from arithmetic.db.models.dummy_model import DummyModel
from arithmetic.web.api.dummy.schema import DummyModelDTO, DummyModelInputDTO
...
async def create_dummy_model(
    ...
    :param dummy_dao: DAO for dummy models.
    """
    await dummy_dao.create_dummy_model(name="")
